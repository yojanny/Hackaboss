...
function App() {
  return (
    <main>
      ...
      {/*El componente Showchildren recibe lo que pongamos entre sus etiquetas como una prop */}
      <ShowChildren>
        Esto va a estar en children dentro de las props de ShowChildren, pueden
        ser componentes o lo que sea
      </ShowChildren>
      <h1>Lista de usuarios</h1>
      {/* useData es una prop de UserList
      Las props son los parámetros que reciben las funciones de los componentes */}
